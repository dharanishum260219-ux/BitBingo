...
// ─── Fantasy Quest Arena Background with Art Elements ─────────────
// Parchment texture with compass rose, corner ornaments, and map grid
...
export function FantasyBackground({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-orange-100 via-amber-50 to-orange-100">
      ...
      {/* Corner Ornament - Top Left - Ornate Heraldic Design */}
      <svg
      ...
      >
        ...
        {/* Left decorative line with flourishes */}
